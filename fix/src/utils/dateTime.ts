...
// Date and time options
const dateOptions: { date: number, month: number, year: number, description: string }[] = _generateDateOptions();
 ...
 */
function _generateDateOptions(): {date: number, month: number, year: number, description: string}[] {
